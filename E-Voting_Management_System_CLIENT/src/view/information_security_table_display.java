 ...
 * @author observer
 */
public class information_security_table_display extends javax.swing.JFrame {

    /**
     * Creates new form test_table_display
     */
    public information_security_table_display() {
        initComponents();
        addColumnTable();
	...
	tableModel.addColumn("Votes");
        ...
        try{
                ...
                List<infoSec_officer> result= service.readinfoSec_officerTable();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("CANDIDATES FOR INFORMATION SECURITY OFFICER");
    ...
    private void saveBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBTNActionPerformed
        ...
        if(candidate_id.trim().isEmpty() ||
            ...
            try{
                    ...
                    infoSec_officer info= new infoSec_officer();
                    info.setCandidate_id(candidate_id);
                    info.setFull_name(candidate_name);
                    info.setImage(imageBytes);
                    info.setDescription(description);
                    
                    Registry reg = LocateRegistry.getRegistry("127.0.0.1", 6000);
                    infoSec_officer_Service service=  (infoSec_officer_Service) reg.lookup("infoSec_officer");
                    int rowsAffected= service.EX_register_InfoSO_candidate(info);
    ...
    private void updateBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBTNActionPerformed
        ...
        if(candidate_id.trim().isEmpty() ||
            ...
            try{
                infoSec_officer model= new infoSec_officer();
                model.setFull_name(candidate_name);
                model.setPosition("GUILD PRESIDENT");
                ...
                int rowsAffected= service.EX_update_InfoSO_candidate(model);
                if(rowsAffected>=1){
    ...
    private void deleteBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBTNActionPerformed
        ...
        if(candidate_id.length()!=5){
            ...
            try{
                ...
                Registry reg = LocateRegistry.getRegistry("127.0.0.1", 6000);
                infoSec_officer_Service service=  (infoSec_officer_Service) reg.lookup("infoSec_officer");
                int rowsAffected= service.EX_delete_InfoSO_candidate(model);
                if(rowsAffected>=1){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(information_security_table_display.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new information_security_table_display().setVisible(true);
            }
        });
    }
