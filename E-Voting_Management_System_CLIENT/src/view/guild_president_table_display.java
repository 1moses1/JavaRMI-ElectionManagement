 ...
 * @author observer
 */
public class guild_president_table_display extends javax.swing.JFrame {

    /**
     * Creates new form test_table_display
     */
    public guild_president_table_display() {
        initComponents();
        addColumnTable();
	...
	tableModel.addColumn("Votes");
        ...
        try{
            ...
            List<guild_president> result= service.readGuildPresidentTable();
            for(guild_president res: result){
    ...
    private void initComponents() {
        ...
        jLabel3.setText("CANDIDATES FOR GUILD PRESIDENT");
        ...
        if(candidate_id.trim().isEmpty() ||
            ...
            JOptionPane.showMessageDialog(this, "ID number must 5 characters", "ERROR", JOptionPane.WARNING_MESSAGE);
                ...
                try {
                    ...
                    guild_president gp= new guild_president();
                    gp.setCandidate_id(candidate_id);
                    gp.setFull_name(candidate_name);
                    gp.setImage(imageBytes);
                    gp.setDescription(description);
                    
                    Registry reg = LocateRegistry.getRegistry("127.0.0.1", 6000);
                    guild_president_Service service= (guild_president_Service) reg.lookup("guild_president");
                    int rowsAffected= service.EX_register_GP_candidate(gp);
    ...
    private void updateBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBTNActionPerformed
        ...
        if(candidate_id.trim().isEmpty() ||
            ...
            try{
                guild_president model= new guild_president();
                ...
                Registry reg = LocateRegistry.getRegistry("127.0.0.1", 6000);
                guild_president_Service service= (guild_president_Service) reg.lookup("guild_president");
                int rowsAffected= service.EX_update_GP_candidate(model);
                if(rowsAffected>=1){
    ...
    private void deleteBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBTNActionPerformed
        ...
        if(candidate_id.length()!=5){
            ...
            try{
                ...
                Registry reg = LocateRegistry.getRegistry("127.0.0.1", 6000);
                guild_president_Service service= (guild_president_Service) reg.lookup("guild_president");
                int rowsAffected= service.EX_delete_GP_candidate(model);
                if(rowsAffected>=1){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(guild_president_table_display.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new guild_president_table_display().setVisible(true);
            }
        });
    }
