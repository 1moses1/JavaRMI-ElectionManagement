 ...
 * @author observer
 */
public class vice_president_table_display extends javax.swing.JFrame {

    /**
     * Creates new form test_table_display
     */
    public vice_president_table_display() {
        initComponents();
        addColumnTable();
	...
	tableModel.addColumn("Votes");
        ...
        try{
            ...
            List<vice_president> result= service.readVicePresidentTable();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("CANDIDATES FOR VICE PRESIDENT");
    ...
    private void saveBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBTNActionPerformed
        ...
        if(candidate_id.trim().isEmpty() ||
            ...
            try{
                    ...
                    vp.setCandidate_id(candidate_id);
                    vp.setFull_name(candidate_name);
                    vp.setImage(imageBytes);
                    vp.setDescription(description);
                    Registry reg = LocateRegistry.getRegistry("127.0.0.1", 6000);
                    vice_president_Service service=  (vice_president_Service) reg.lookup("vice_president");
                    int rowsAffected= service.EX_register_VP_candidate(vp);
    ...
    private void updateBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBTNActionPerformed
        ...
        if(candidate_id.trim().isEmpty() ||
            ...
            try{
                vice_president model= new vice_president();
                model.setFull_name(candidate_name);
                model.setPosition("VICE PRESIDENT");
                model.setDescription(description);
                model.setImage(imageBytes);
                model.setCandidate_id(candidate_id);
                Registry reg = LocateRegistry.getRegistry("127.0.0.1", 6000);
                vice_president_Service service=  (vice_president_Service) reg.lookup("vice_president");
                int rowsAffected= service.EX_update_VP_candidate(model);
                if(rowsAffected>=1){
    ...
    private void deleteBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBTNActionPerformed
        ...
        if(candidate_id.length()!=5){
            ...
            try{
                ...
                Registry reg = LocateRegistry.getRegistry("127.0.0.1", 6000);
                vice_president_Service service=  (vice_president_Service) reg.lookup("vice_president");
                int rowsAffected= service.EX_delete_VP_candidate(model);
                if(rowsAffected>=1){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vice_president_table_display.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vice_president_table_display().setVisible(true);
            }
        });
    }
