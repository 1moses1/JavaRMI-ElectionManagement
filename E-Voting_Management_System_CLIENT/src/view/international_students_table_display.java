 ...
 * @author observer
 */
public class international_students_table_display extends javax.swing.JFrame {

    /**
     * Creates new form test_table_display
     */
    public international_students_table_display() {
        initComponents();
        addColumnTable();
	...
	tableModel.addColumn("Votes");
        ...
        try{
            ...
            List<interStudent_officer> result= service.readinterStudent_officerTable();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("CANDIDATES FOR INTERNATIONAL STUDENTS OFFICER");
    ...
    private void saveBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBTNActionPerformed
        ...
        if(candidate_id.trim().isEmpty() ||
            ...
            try{
                    interStudent_officer inter= new interStudent_officer();
                    inter.setCandidate_id(candidate_id);
                    inter.setFull_name(candidate_name);
                    inter.setImage(imageBytes);
                    inter.setDescription(description);
                    
                    Registry reg = LocateRegistry.getRegistry("127.0.0.1", 6000);
                    interStudent_officer_Service service= (interStudent_officer_Service) reg.lookup("interStudent_officer");
                    int rowsAffected= service.EX_register_InterSO_candidate(inter);
    ...
    private void updateBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBTNActionPerformed
        ...
        if(candidate_id.trim().isEmpty() ||
            ...
            try{
                interStudent_officer model= new interStudent_officer();
                model.setFull_name(candidate_name);
                model.setPosition("INTERNATIONAL STUDENTS OFFICER");
                ...
                Registry reg = LocateRegistry.getRegistry("127.0.0.1", 6000);
                interStudent_officer_Service service= (interStudent_officer_Service) reg.lookup("interStudent_officer");
                int rowsAffected= service.EX_update_InterSO_candidate(model);
                if(rowsAffected>=1){
    ...
    private void deleteBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBTNActionPerformed
        ...
        if(candidate_id.length()!=5){
            ...
            try{
                ...
                Registry reg = LocateRegistry.getRegistry("127.0.0.1", 6000);
                interStudent_officer_Service service= (interStudent_officer_Service) reg.lookup("interStudent_officer");
                int rowsAffected= service.EX_delete_InterSO_candidate(model);
                if(rowsAffected>=1){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(international_students_table_display.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new international_students_table_display().setVisible(true);
            }
        });
    }
